...
enum class AdjustmentType(
    ...
    CURVES(
        displayName = "Curves",
        defaultParameters = mapOf(
            "point_0_x" to 0f, "point_0_y" to 0f,
            "point_1_x" to 64f, "point_1_y" to 64f,
            "point_2_x" to 128f, "point_2_y" to 128f,
            "point_3_x" to 192f, "point_3_y" to 192f,
            "point_4_x" to 255f, "point_4_y" to 255f
        ),
        parameterRanges = mapOf(
            "point_0_x" to 0f..255f, "point_0_y" to 0f..255f,
            "point_1_x" to 0f..255f, "point_1_y" to 0f..255f,
            "point_2_x" to 0f..255f, "point_2_y" to 0f..255f,
            "point_3_x" to 0f..255f, "point_3_y" to 0f..255f,
            "point_4_x" to 0f..255f, "point_4_y" to 0f..255f
        )
    ),
    LEVELS(
        displayName = "Levels",
    ...
    SELECTIVE_COLOR(
        ...
        defaultParameters = mapOf(
            "reds_cyan" to 0f, "reds_magenta" to 0f, "reds_yellow" to 0f, "reds_black" to 0f,
            "yellows_cyan" to 0f, "yellows_magenta" to 0f, "yellows_yellow" to 0f, "yellows_black" to 0f,
            "greens_cyan" to 0f, "greens_magenta" to 0f, "greens_yellow" to 0f, "greens_black" to 0f,
            "cyans_cyan" to 0f, "cyans_magenta" to 0f, "cyans_yellow" to 0f, "cyans_black" to 0f,
            "blues_cyan" to 0f, "blues_magenta" to 0f, "blues_yellow" to 0f, "blues_black" to 0f,
            "magentas_cyan" to 0f, "magentas_magenta" to 0f, "magentas_yellow" to 0f, "magentas_black" to 0f,
            "whites_cyan" to 0f, "whites_magenta" to 0f, "whites_yellow" to 0f, "whites_black" to 0f,
            "neutrals_cyan" to 0f, "neutrals_magenta" to 0f, "neutrals_yellow" to 0f, "neutrals_black" to 0f,
            "blacks_cyan" to 0f, "blacks_magenta" to 0f, "blacks_yellow" to 0f, "blacks_black" to 0f
        ),
        parameterRanges = (buildMap {
     ...
     */
    fun validateParameter(key: String, value: Float): Float {
