...
- **Advanced transform workflow** — numerical full-layer affine editing exists; interactive handles, selected-pixel transforms, adjustable pivot, perspective, distortion and snapping do not.
